...
if(isset($_POST['pay'])){
    ...
    //Callback url where the response from daraja api will be sent asychronously
    $Callback_url = 'https://f899-41-90-64-220.ngrok.io/Lipa-na-mpesa/callback_url.php';
  ...
  //Pay load to be sent to the daraja api
